var S=Object.defineProperty,U=Object.defineProperties;var O=Object.getOwnPropertyDescriptors;var $=Object.getOwnPropertySymbols;var F=Object.prototype.hasOwnProperty,L=Object.prototype.propertyIsEnumerable;var x=(e,t,r)=>t in e?S(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,T=(e,t)=>{for(var r in t||(t={}))F.call(t,r)&&x(e,r,t[r]);if($)for(var r of $(t))L.call(t,r)&&x(e,r,t[r]);return e},v=(e,t)=>U(e,O(t));import{n as g,p as E,r as h,j as o,G as D,c as j,a,b as c,T as P,R as G,d as M}from"./vendor.3276dfbe.js";const N=function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function r(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=r(n);fetch(n.href,i)}};N();var l;(function(e){e.setColorTheme="SET_COLOR_THEME",e.addTodo="ADD_TODO",e.toggleTodoCompletion="TOGGLE_TASK_COMPLETION",e.deleteTodo="DELETE_TODO",e.clearCompleted="CLEAR_COMPLETED",e.setFilter="SET_FILTER"})(l||(l={}));const I=e=>({type:l.setColorTheme,payload:e}),H=e=>({type:l.addTodo,payload:e}),R=e=>({type:l.toggleTodoCompletion,payload:e}),_=e=>({type:l.deleteTodo,payload:e}),B=()=>({type:l.clearCompleted}),J=e=>({type:l.setFilter,payload:e});var m;(function(e){e.light="light",e.dark="dark"})(m||(m={}));var p;(function(e){e.all="all",e.active="active",e.completed="completed"})(p||(p={}));const w={colorTheme:window.matchMedia("(prefers-color-scheme: dark)").matches?m.dark:m.light,todos:[{id:g(),task:"Complete online JavaScript course",completed:!0},{id:g(),task:"Jog around the park 3x",completed:!1},{id:g(),task:"10 minutes meditation",completed:!1},{id:g(),task:"Read for 1 hour",completed:!1},{id:g(),task:"Pick up groceries",completed:!1},{id:g(),task:"Complete Todo App on Frontend Mentor",completed:!1}],todosFilter:p.all},A=E((e,t)=>{switch(t.type){case l.setColorTheme:{e.colorTheme=t.payload;break}case l.addTodo:{const r={id:g(),task:t.payload,completed:!1};e.todos.push(r);break}case l.toggleTodoCompletion:{const r=e.todos.find(({id:s})=>s===t.payload);r&&(r.completed=!r.completed);break}case l.deleteTodo:{const r=e.todos.findIndex(({id:s})=>s===t.payload);r!==-1&&e.todos.splice(r,1);break}case l.clearCompleted:{const r=e.todos.filter(({completed:s})=>!s);e.todos=r;break}case l.setFilter:{e.todosFilter=t.payload;break}}}),C=h.exports.createContext([w,()=>{}]),u=()=>h.exports.useContext(C),K=({children:e})=>{const[t,r]=h.exports.useReducer(A,w,n=>{try{const i=window.localStorage.getItem("global-state");return i?JSON.parse(i):n}catch{return console.error("Local storage is not accessible, the app state won't be saved!"),n}});h.exports.useEffect(()=>{try{window.localStorage.setItem("global-state",JSON.stringify(t))}catch{}},[t]);const s=h.exports.useMemo(()=>[t,r],[t]);return o(C.Provider,{value:s,children:e})},W=({palette:e})=>j("html{font-size:62.5%;}body{background-color:",e.bgPrimary,";color:",e.text,";font-size:1.6rem;font-family:'Josefin Sans',sans-serif;line-height:normal;letter-spacing:-0.015em;word-break:break-word;}",""),b={name:"91ig8t",styles:"position:absolute;width:1px;height:1px;padding:0;border:0;overflow:hidden;white-space:nowrap;clip:rect(0 0 0 0);clip-path:inset(50%)"},X=()=>o(D,{styles:W});var f=a("div",{target:"e1wulm1d0"})(({theme:{palette:e}})=>`
  ...
  `,""),we=()=>{const[{colorTheme:e}]=u();return c(P,{theme:$e(e),children:[o(X,{}),o(xe,{children:c(Te,{children:[o(pe,{}),o(ke,{}),o(le,{}),o(ve,{children:"Drag and drop to reorder list"})]})})]})};G.render(o(M.StrictMode,{children:o(K,{children:o(we,{})})}),document.getElementById("root"));
//# sourceMappingURL=index.0fdee88d.js.map
